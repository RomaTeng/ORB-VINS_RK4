...
Now a more accurate integration code also being RK4 has been used, see "RK4OnManifold.cpp".  
...
Now this new IMU factor shows some improvements on our tests. We may upload this once we ensure  it is  the best IMU factor in the **East Sphere**.
