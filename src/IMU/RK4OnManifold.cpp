...
//	_j3_w += other._kj_dJ3_w;
    ...
    _j3_a += other._kj_dJ3_a - 0.5*dt*dt*_J1;
    _j3_w += other._kj_dJ3_w - 0.5*dt*(other._kj_dJ2_a)*_J1*_j1_w;
	...
	//_J3 += other._kj_dJ3;
      ...
      _J2 += _J1* Sophus::SO3::JacobianL(other._kj_dJ1)
             *_J1.transpose()*other._kj_dJ2;
      _J3 += other._kj_dJ3+0.5*dt*other._kj_dJ2;
