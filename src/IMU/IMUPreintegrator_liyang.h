...
public:
	...
	// TODO NEW
	/*Eigen::Matrix3d _J1;
	Eigen::Matrix<double,3,1> _J2, _J3;
	Eigen::Matrix3d _j1_w, _j2_w, _j2_a, _j3_w, _j3_a;
	Eigen::Matrix<double,9,9> _P;*/
	inline Eigen::Matrix3d getJ1() const {return _rk4Preint._J_State._J1;}
	inline Eigen::Matrix<double,3,1> getJ2() const {return _rk4Preint._J_State._J2;}
	inline Eigen::Matrix<double,3,1> getJ3() const {return _rk4Preint._J_State._J3;}

	inline Eigen::Matrix3d getj1w() const {return _rk4Preint._J_State._j1_w;}
	inline Eigen::Matrix3d getj2w() const {return _rk4Preint._J_State._j2_w;}
	inline Eigen::Matrix3d getj2a() const {return _rk4Preint._J_State._j2_a;}
	inline Eigen::Matrix3d getj3w() const {return _rk4Preint._J_State._j3_w;}
	inline Eigen::Matrix3d getj3a() const {return _rk4Preint._J_State._j3_a;}

	inline Eigen::Matrix<double,9,9> getP() const {return _rk4Preint._J_Cov._P;}



    
    // The followings are just utility functions like: right jacobians and its inverse SkewSym etc...
    ...
    // TODO Looks like the following codes are useless !!! at least I didn't use them in my implementation
	...
	// TODO 4th order Runge-Kutta integration
	// inline 
